const GetStarted = () => {
    return (
        <div className="flex items-center justify-center h-[300px] md:h-[450px] bg-cover bg-no-repeat w-full" style={{backgroundImage: 'url(/get-started.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}>
